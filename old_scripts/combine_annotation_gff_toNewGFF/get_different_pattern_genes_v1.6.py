#python3 /media/pflanz/Hs1-2/Scripts/combine_annotation_gff_toNewGFF/get_different_pattern_genes_v1.6.py -diff_all /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_filtered.diff --fpkm_all /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/cuffdiff/all_stages_restricted/genes.fpkm_tracking -diff_14 /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/13_gene_exp.diff -diff_47 /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/36_gene_exp.diff -diff_78 /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/78_gene_exp.diff -diff_89 /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/89_gene_exp.diff -diff_79 /media/pflanz/BackUps/Brassicanapus/gatk/second_Attempt/gene_exp_analysis/68_gene_exp.diff
...
for i in tqdm(list(fpkm_all_df['tracking_id'].unique())):
    ...
    if (diff_14_df_1[diff_14_df_1[:,1]==i,13]=="yes"): # significant between q1 q4
        if float(all_stages_list[1])>=1.0 and float(all_stages_list[5])<1.0 and float(all_stages_list[6])<=1.0 and float(all_stages_list[7])<=1.0 and float(all_stages_list[8])<=1.0:# set lower/upper limits 
    ...
    if float(all_stages_list[1])<=1.0 and float(all_stages_list[2])<=1.0 and float(all_stages_list[3])<=1.0 and float(all_stages_list[4])<=1.0 and float(all_stages_list[5])>0 and float(all_stages_list[8])>=2:
